...
BOOST_AUTO_TEST_CASE(read_digital_outputs_func)
{
        ...
        BOOST_TEST(2 == result.size());
        auto do0 = result[0];
        BOOST_TEST("digital_output0" == do0->GetToken());
        BOOST_TEST(true == do0->IsEnabled());
        BOOST_TEST(true == do0->GetState());
        auto do1 = result[1];
        BOOST_TEST("digital_output1" == do1->GetToken());
        BOOST_TEST(false == do1->IsEnabled());
        BOOST_TEST(false == do1->GetState());
}
