...
namespace osrv
{
    namespace event
    {
        ...
        class ExternalToggleEventGenerator : public IEventGenerator
        {
        public:
                ExternalToggleEventGenerator(const std::string& source_token, const std::string& data_name,
                        const std::string& topic, boost::asio::io_context& io_context, const ILogger& logger,
